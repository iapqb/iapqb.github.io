...
현재 확정 작업 중인 범위는 **공통 코어**이다. 모듈은 **표준으로 먼저 공개**하고, 평가에 반영하는 것은 별도의 절차를 거친다. 본 절의 내용을 근거로 어떠한 자격도 지금 발급하지 않는다.
...
*본 문서는 v1.0 공개초안으로 확정 전이며 효력이 없습니다. 본원은 현재 어떠한 자격도 발급하지 않으며 검정을 시행하지 않았습니다.*
