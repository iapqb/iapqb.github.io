...
본 표준은 직무에서 생성형 AI를 사용하는 실무자가 갖추어야 할 역량을 정의한다. 특정 제품·모델·산업에 종속되지 않으며, AI를 업무에 도입하는 모든 직군에 적용된다. 본 표준은 IAPQB 자격검정(IAPQBCertifiedAppliedAI — Foundation·Associate·Professional·Strategist)의 검정기준의 근거 문서이며, 조직의 AI 교육 설계·채용 요건 정의에도 참조될 수 있다.
